...
const rows = [
  {
    ...
    description:
      "A foundational course covering core programming concepts using Python. Students will build small projects from the ground up.",
    prerequisites: "",
  ...
  },
  {
    ...
    description:
      "Covers the design and analysis of fundamental data structures and algorithms. Prerequisite for most upper-level CS courses.",
    prerequisites: "CS101",
  ...
  },
  {
    ...
    description:
      "An introduction to relational database theory and practice. Students will design schemas and implement full database applications.",
    prerequisites: "CS201",
  ...
  },
  {
    ...
    description:
      "Introduces cloud computing concepts and hands-on practice with major cloud providers. Focus on practical deployment skills.",
    prerequisites: "CS301",
  ...
  },
  {
    ...
    description:
      "A graduate-level treatment of machine learning theory and application. Students implement models from scratch and via scikit-learn.",
    prerequisites: "CS201",
