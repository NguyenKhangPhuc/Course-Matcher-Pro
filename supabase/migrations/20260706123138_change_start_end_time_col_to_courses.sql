alter table "public"."courses" alter column "end_date" set data type date using "end_date"::date;

alter table "public"."courses" alter column "enrollment_end_date" set data type date using "enrollment_end_date"::date;

alter table "public"."courses" alter column "enrollment_start_date" set data type date using "enrollment_start_date"::date;

alter table "public"."courses" alter column "start_date" set data type date using "start_date"::date;
